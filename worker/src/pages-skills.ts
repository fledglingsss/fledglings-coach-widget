...
.grade{background:linear-gradient(135deg,#ED9249,#D9452B);color:#fff;padding:18px 28px;border-radius:18px;
...
.stat.st3{background:#FBF0E2}.stat.st3 .v{color:#B96A16}.stat.st3 .h{color:#B96A16}
